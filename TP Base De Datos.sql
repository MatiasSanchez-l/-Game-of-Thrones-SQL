...
/*¿Cuáles son las ciudades que no forman parte de ningún reino?*/
select *
from ciudad
where nombre_reino is null;

/*¿Qué casas son las más pacíficas? Se entiende que una casa es pacífica cuando nunca
...
/*Reporte de casas ordenado según cantidad de integrantes.*/
...
/*Lista de los personajes más ricos, donde la riqueza se mide de acuerdo a la extensión
...
/*¿Qué personajes han tenido todas las profesiones disponibles?*/
select p.nombre
from personaje as p
where not exists 
(select *
